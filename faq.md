...
### Comment m'abonner ?
1. Connectez-vous sur [french.gg](https://french.gg)
2. Accédez à la page [Premium](https://french.gg/premium)
3. Choisissez votre formule
4. Payez via Discord Store ou PayPal
5. L'activation est automatique

### Puis-je annuler mon abonnement ?
Oui, vous pouvez annuler à tout moment :
- **Via Discord Store** : Gérez vos abonnements dans Discord
- **Via le site** : Section "Mes abonnements" dans votre profil
- **Support** : Contactez-nous pour assistance

L'annulation prend effet à la fin de la période en cours.

## 🛠️ Problèmes Techniques

### Le site est lent ou ne charge pas
Solutions à essayer :
1. **Rafraîchissez** la page (Ctrl+F5)
2. **Vérifiez votre connexion** internet
3. **Changez de navigateur** (Chrome, Firefox, Edge)
4. **Désactivez** temporairement les extensions
5. **Consultez** [french.gg/statut](https://french.gg/statut) pour les incidents

### Erreur de connexion Discord
Si vous ne pouvez pas vous connecter :
1. **Déconnectez-vous** de Discord puis reconnectez-vous
2. **Videz le cache** de votre navigateur
3. **Vérifiez** que Discord fonctionne normalement
4. **Essayez** en navigation privée/incognito
5. **Contactez le support** si le problème persiste

### Mes données ne s'affichent pas
Pour résoudre les problèmes d'affichage :
1. **Attendez** quelques minutes (synchronisation en cours)
2. **Rafraîchissez** votre profil Discord
3. **Vérifiez** vos paramètres de confidentialité
4. **Reconnectez-vous** à French.gg
5. **Signalez** le problème au support

## 📞 Contact et Support

### Comment contacter le support ?
Plusieurs moyens à votre disposition :
- **Discord** : [discord.gg/gXXEUqUs9A](https://discord.gg/gXXEUqUs9A) (le plus rapide)
- **Email** : contact@delavigne-digital.fr
- **Site web** : Formulaire de contact sur french.gg

### Quels sont les horaires du support ?
- **Discord communautaire** : 24h/7j (entraide entre utilisateurs)
- **Support officiel** : Lundi-Vendredi 9h-18h (GMT+1)
- **Urgences** : Traitement prioritaire 7j/7

### Temps de réponse moyens
- **Premium** : < 2h en moyenne
- **Utilisateurs standard** : < 24h en moyenne
- **Urgences techniques** : < 1h

---

## 💡 Vous ne trouvez pas votre réponse ?

**Rejoignez notre Discord support :** [discord.gg/gXXEUqUs9A](https://discord.gg/gXXEUqUs9A)

La communauté et notre équipe sont là pour vous aider !

*FAQ mise à jour : Novembre 2024*